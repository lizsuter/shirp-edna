...
```{r}
# by scientific name
myColors_sciname <- setNames(c("steelblue4","#DF536B","#61D04F","#2297E6","#28E2E5","#CD0BBC", "#F5C710","linen","#6A3D9A","#FF7F00","gray","violet","#FDBF6F","gold3","darkseagreen","chocolate4", "slateblue1"), commonnames$Species[which(commonnames$Species %in% unique(c(most_abund_all4_datasets$Species, most_abund_all4_datasets$Species)))])
# by common name
myColors_comname <- setNames(c("steelblue4","#DF536B","#61D04F","#2297E6","#28E2E5","#CD0BBC", "#F5C710","linen","#6A3D9A","#FF7F00","gray","violet","#FDBF6F","gold3","darkseagreen","chocolate4", "slateblue1"),commonnames$CommonName[which(commonnames$Species %in% unique(c(most_abund_all4_datasets$Species, most_abund_all4_datasets$Species)))])
...
Fix new colors- some of these species were not plotted before and some were. Keep colors consistent
```{r}
# Look at existing color schemes
myColors_comname
myColors_sciname

# list species from pos ctl sample which are not already in my color scheme
setdiff(data.frame(unique(tax_table(ps2024_exp_mifish_glommed_posctl)))$CommonName, names(myColors_comname))
setdiff(data.frame(unique(tax_table(ps2024_exp_mifish_glommed_posctl)))$Species, names(myColors_sciname))

# assign them colors
temp_color <- setNames(c("springgreen","blue4","khaki3"), setdiff(data.frame(unique(tax_table(ps2024_exp_mifish_glommed_posctl)))$CommonName, names(myColors_comname)))
temp_color2 <- setNames(c("springgreen","blue4","khaki3"), setdiff(data.frame(unique(tax_table(ps2024_exp_mifish_glommed_posctl)))$Species, names(myColors_sciname)))

# append to existing color vector
myColors_comname <- c(myColors_comname,temp_color)
myColors_sciname <- c(myColors_sciname,temp_color2)

```

```{r}
ps2024_exp_mifish_posctl_barplot <- plot_bar(ps2024_exp_mifish_glommed_posctl, fill = "CommonName", title = "2024 Expedition: Positive Controls: Read Abundance") + 
...
ps2024_exp_mifish_posctl_ra_barplot <- plot_bar(ps2024_exp_mifish_glommed_ra_posctl, fill = "CommonName", title = "2024 Expedition: Positive Controls: Relative Abundance") + 
...
ggsave(plot = ps2024_exp_mifish_posctl_barplot, filename = "figures-expedition/2024_exp_mifish_posctl_barplot.jpg", width = 7, height = 5, units = "in")
ggsave(plot = ps2024_exp_mifish_posctl_ra_barplot, filename = "figures-expedition/2024_exp_mifish_posctl_ra_barplot.jpg", width = 7, height = 5, units = "in")
...
# list species from pos ctl sample which are not already in my color scheme
setdiff(data.frame(unique(tax_table(ps2024_trawl_mifish_glommed_posctl)))$CommonName, names(myColors_comname))
setdiff(data.frame(unique(tax_table(ps2024_trawl_mifish_glommed_posctl)))$Species, names(myColors_sciname))

# assign them colors
rm(temp_color, temp_color2)
temp_color <- setNames(c("chartreuse4","turquoise","firebrick","lightsalmon3","grey32","lightcoral","violetred3"), setdiff(data.frame(unique(tax_table(ps2024_trawl_mifish_glommed_posctl)))$CommonName, names(myColors_comname)))
temp_color2 <- setNames(c("chartreuse4","turquoise","firebrick","lightsalmon3","grey32","lightcoral","violetred3"), setdiff(data.frame(unique(tax_table(ps2024_trawl_mifish_glommed_posctl)))$Species, names(myColors_sciname)))
...
```{r}
ps2024_trawl_mifish_posctl_barplot <- plot_bar(ps2024_trawl_mifish_glommed_posctl, fill = "CommonName", title = "2024 Trawl (Sept. only): Positive Controls: Read Abundance") + 
  scale_y_continuous(name="Read Abundance")+
  theme_minimal() +
  theme(axis.title.x=element_blank(), legend.title = element_blank())+
  scale_fill_manual(values = myColors_comname) 
...
ps2024_trawl_mifish_posctl_ra_barplot <- plot_bar(ps2024_trawl_mifish_glommed_ra_posctl, fill = "CommonName", title = "2024 Trawl (Sept. only): Positive Controls: Relative Abundance") + 
  scale_y_continuous(name="Relative Abundance")+
  theme_minimal() +
  theme(axis.title.x=element_blank(), legend.title = element_blank())+
  scale_fill_manual(values = myColors_comname) 
...
ggsave(plot = ps2024_trawl_mifish_posctl_barplot, filename = "figures-expedition/2024_trawl_mifish_posctl_barplot.jpg", width = 7, height = 5, units = "in")
ggsave(plot = ps2024_trawl_mifish_posctl_ra_barplot, filename = "figures-expedition/2024_trawl_mifish_posctl_ra_barplot.jpg", width = 7, height = 5, units = "in")
...
Append new colors to ongoing color scheme
...
# list species from pos ctl sample which are not already in my color scheme
setdiff(unique(ps2024_exp_mifish_glommed_df$CommonName), names(myColors_comname))
setdiff(unique(ps2024_exp_mifish_glommed_df$Species), names(myColors_sciname))

# assign them colors- THERE ARE 29 NEW ONES!!!
rm(temp_color, temp_color2)
temp_color <- setNames(c("cadetblue4","burlywood3","darkorange3","darkgreen","floralwhite","aquamarine2","deeppink2","dodgerblue3","greenyellow","grey97","indianred2","hotpink3","honeydew2","mediumorchid","mediumblue","maroon4","lightyellow2","lightsteelblue","lightseagreen","lightsalmon","thistle","plum4","powderblue","red","midnightblue","peachpuff","tomato","tan4","rosybrown2"), setdiff(unique(ps2024_exp_mifish_glommed_df$CommonName), names(myColors_comname)))
temp_color2 <- setNames(c("cadetblue4","burlywood3","darkorange3","darkgreen","floralwhite","aquamarine2","deeppink2","dodgerblue3","greenyellow","grey97","indianred2","hotpink3","honeydew2","mediumorchid","mediumblue","maroon4","lightyellow2","lightsteelblue","lightseagreen","lightsalmon","thistle","plum4","powderblue","red","midnightblue","peachpuff","tomato","tan4","rosybrown2"), setdiff(unique(ps2024_exp_mifish_glommed_df$Species), names(myColors_sciname)))
...
ggsave(plot = bubbleplot_comname_2024_expedition_mifish_Bayside, filename = "figures-expedition/bubbleplot_comname_2024_expedition_mifish_Bayside.jpg", width = 10, height = 6, units = "in")
```
...
# list species from pos ctl sample which are not already in my color scheme
setdiff(unique(ps2024_exp_elas_glommed_df$CommonName), names(myColors_comname))
setdiff(unique(ps2024_exp_elas_glommed_df$Species), names(myColors_sciname))

# assign them colors- 4 new ones
rm(temp_color, temp_color2)
temp_color <- setNames(c("darksalmon","blueviolet","darkslategrey","lavender"), setdiff(unique(ps2024_exp_elas_glommed_df$CommonName), names(myColors_comname)))
temp_color2 <- setNames(c("darksalmon","blueviolet","darkslategrey","lavender"), setdiff(unique(ps2024_exp_elas_glommed_df$Species), names(myColors_sciname)))
...
# Turn CommonName into factor for plotting in correct order
ps2024_exp_mifish_whole_forplot$CommonName_f= factor(ps2024_exp_mifish_whole_forplot$CommonName, levels=sort(unique(ps2024_exp_mifish_whole_forplot$CommonName)))
...
piechart_2024_exp_mifish_all <- ggplot(ps2024_exp_mifish_whole_forplot, 
                                aes(x= "", 
                                    y = rel_abun_percent, 
                                    fill=factor(`CommonName`, levels = `CommonName_f`))) +
...
ggsave(plot = speciesoccurrence_habitat, filename = "figures-expedition/speciesoccurrence_habitat.jpg", width = 12, height = 7, units = "in")

ggsave(plot = speciesoccurrence_daynight, filename = "figures-expedition/speciesoccurrence_daynight.jpg", width = 12, height = 7, units = "in")

ggsave(plot = speciesoccurrence_bayside, filename = "figures-expedition/speciesoccurrence_bayside.jpg", width = 12, height = 7, units = "in")
...
ggsave(plot = speciesoccurrence_habitat, filename = "figures-expedition/speciesoccurrence_habitat_elas.jpg", width = 12, height = 7, units = "in")

ggsave(plot = speciesoccurrence_daynight, filename = "figures-expedition/speciesoccurrence_daynight_elas.jpg", width = 12, height = 7, units = "in")

ggsave(plot = speciesoccurrence_bayside, filename = "figures-expedition/speciesoccurrence_bayside_elas.jpg", width = 12, height = 7, units = "in")

```


# Species Richness- CONTINUE HERE 1/16/25
```{r}
