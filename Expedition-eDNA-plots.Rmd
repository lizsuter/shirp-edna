...
Expedition/Elas02: 31
SeptemberTrawl/MiFish: 80
SeptemberTrawl/Elas02: 31
...
exp_mifish_species_abundance_plot <- ggplot(exp_mifish_species_abundance, aes(x = 1, y = RelativeAbundance, fill = Species)) +
  geom_bar(stat = "identity") +
  scale_y_continuous(labels = scales::percent_format()) + # Y-axis as percentages
  labs(x = NULL, y = "Relative Abundance (%)", title = "Relative Abundance of top 10 Species- Expedition: MiFish Library") +
  theme_minimal() +
...
exp_mifish_species_abundance_plot

ggsave(plot = exp_mifish_species_abundance_plot, filename = "figures-expedition/exp_mifish_species_abundance_plot_all.jpg")
...
exp_elas_species_abundance <- exp_elas_species_abundance %>%
  arrange(desc(RelativeAbundance)) %>%
  slice_head(n = 5) # Show top 5 species

# Plot a stacked barplot
exp_elas_species_abundance_plot <- ggplot(exp_elas_species_abundance, aes(x = 1, y = RelativeAbundance, fill = Species)) +
  geom_bar(stat = "identity") +
  scale_y_continuous(labels = scales::percent_format()) + # Y-axis as percentages
  labs(x = NULL, y = "Relative Abundance (%)", title = "Relative Abundance of top 5 Species- Expedition: Elas02 Library") +
  theme_minimal() +
  theme(axis.text.x = element_blank(), axis.ticks.x = element_blank(), panel.grid.major.x = element_blank()) +
  guides(fill = guide_legend(ncol = 2)) # Adjust legend columns if needed
exp_elas_species_abundance_plot

ggsave(plot = exp_elas_species_abundance_plot, filename = "figures-expedition/exp_elas_species_abundance_plot_all.jpg")
...
# Plot a stacked barplot
trawl_mifish_species_abundance_plot <- ggplot(trawl_mifish_species_abundance, aes(x = 1, y = RelativeAbundance, fill = Species)) +
  geom_bar(stat = "identity") +
  scale_y_continuous(labels = scales::percent_format()) + # Y-axis as percentages
  labs(x = NULL, y = "Relative Abundance (%)", title = "Relative Abundance of top 10 Species- Sept Trawl Samples: MiFish Library") +
  theme_minimal() +
  theme(axis.text.x = element_blank(), axis.ticks.x = element_blank(), panel.grid.major.x = element_blank()) +
  guides(fill = guide_legend(ncol = 2)) # Adjust legend columns if needed

trawl_mifish_species_abundance_plot

ggsave(plot = trawl_mifish_species_abundance_plot, filename = "figures-expedition/trawl_mifish_species_abundance_plot_all.jpg")
...
# Plot a stacked barplot
trawl_elas_species_abundance_plot <- ggplot(trawl_elas_species_abundance, aes(x = 1, y = RelativeAbundance, fill = Species)) +
  geom_bar(stat = "identity") +
  scale_y_continuous(labels = scales::percent_format()) + # Y-axis as percentages
  labs(x = NULL, y = "Relative Abundance (%)", title = "Relative Abundance of top 5 Species- Sept Trawl Samples: Elas02 Library") +
  theme_minimal() +
  theme(axis.text.x = element_blank(), axis.ticks.x = element_blank(), panel.grid.major.x = element_blank()) +
  guides(fill = guide_legend(ncol = 2)) # Adjust legend columns if needed

trawl_elas_species_abundance_plot

ggsave(plot = trawl_elas_species_abundance_plot, filename = "figures-expedition/trawl_elas_species_abundance_plot_all.jpg")
