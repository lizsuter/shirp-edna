...
sample_metadata_elas <- left_join(sample_metadata_elas, sample_metadata2, by = c("Name_Deploy_Cartr_Library" = "Deploy_Cartr_Library"))
...
```
### 1/7/24 PAUSED HERE- FIX ABOVE. THE "BY" IN LINE 86 NOT WORKING BC OF DIF LIBRARY NAMES IN ELAS NAME_DEPLOY_CARTR
