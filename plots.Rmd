...
---
[Preview notebook](http://htmlpreview.github.io/?https://github.com/lizsuter/shirp-edna/blob/main/plots.nb.html)
...
myColors_sciname <- setNames(c("steelblue4","#DF536B","#61D04F","#2297E6","#28E2E5","#CD0BBC", "#F5C710","brown","#6A3D9A","#FF7F00","gray","gold1","#FDBF6F","#FB9A99","khaki2","orchid1"), commonnames$Species[which(commonnames$Species %in% unique(c(ps2021glommed_df$Species, ps2023glommed_df$Species)))])
myColors_comname <- setNames(c("steelblue4","#DF536B","#61D04F","#2297E6","#28E2E5","#CD0BBC", "#F5C710","brown","#6A3D9A","#FF7F00","gray","gold1","#FDBF6F","#FB9A99","khaki2","orchid1"),commonnames$CommonName[which(commonnames$Species %in% unique(c(ps2021glommed_df$Species, ps2023glommed_df$Species)))])
