...
```{r}
station_gps <- read_csv("raw_data/Salzmanetal_GPS_locations.csv")
station_gps
...
ggsave("figures-salzman-etal-elasmos/map.jpg", plot = station_map)
...
- remove AMW RB1 - Libby is not confident about that one, wasn't present when collected
- change other labels: 
...
```{r}
# remove AMW_RB1:
ps2021glommed <- subset_samples(ps2021glommed, replicates != "AMW_RB1")
ps2021glommed_ra <- subset_samples(ps2021glommed_ra, replicates != "AMW_RB1")
...
ps2021_posctl_barplot <- plot_bar(
    subset_samples(ps2021glommed, controls=="positive"),
    x    = "replicates",
    fill = "Species",
    title= "2021 Positive Controls: Read Abundance"
  ) +
...
ps2021_posctl_ra_barplot <- plot_bar(
    subset_samples(ps2021glommed_ra, controls=="positive"),
    x    = "replicates",
    fill = "Species",
    title= "2021 Positive Controls: Relative Abundance"
  ) +
...
ggsave(plot = ps2021_posctl_barplot, filename = "figures-salzman-etal-elasmos/2021_posctl_barplot.jpg", width = 7, height = 5, units = "in")
...
ggsave(plot = ps2021_posctl_ra_barplot, filename = "figures-salzman-etal-elasmos/2021_posctl_ra_barplot.jpg", width = 7, height = 5, units = "in")
...
myColors_sciname <- setNames(c("steelblue4","#DF536B","#61D04F","#2297E6","#28E2E5","#CD0BBC", "#F5C710","brown","#6A3D9A","#FF7F00","gray","orchid1","#FDBF6F","gold1","#FB9A99","khaki2"), commonnames$Taxon[which(commonnames$Taxon %in% unique(c(ps2021glommed_df$Species, ps2023glommed_df$Species)))])
myColors_comname <- setNames(c("steelblue4","#DF536B","#61D04F","#2297E6","#28E2E5","#CD0BBC", "#F5C710","brown","#6A3D9A","#FF7F00","gray","orchid1","#FDBF6F","gold1","#FB9A99","khaki2"),commonnames$CommonName[which(commonnames$Taxon %in% unique(c(ps2021glommed_df$Species, ps2023glommed_df$Species)))])
...
ggsave(plot = bubbleplot_comname_2021, filename = "figures-salzman-etal-elasmos/bubbleplot_comname_2021.jpg", width = 7, height = 7, units = "in")
ggsave(plot = bubbleplot_sciname_2021, filename = "figures-salzman-etal-elasmos/bubbleplot_sciname_2021.jpg", width = 6, height = 7, units = "in")
ggsave(plot = bubbleplot_comname_2021_ra, filename = "figures-salzman-etal-elasmos/bubbleplot_comname_2021_ra.jpg", width = 7, height = 7, units = "in")
ggsave(plot = bubbleplot_sciname_2021_ra, filename = "figures-salzman-etal-elasmos/bubbleplot_sciname_2021_ra.jpg", width = 6, height = 7, units = "in")
```
